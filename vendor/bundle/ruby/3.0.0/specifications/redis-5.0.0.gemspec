...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<redis-client>.freeze, ["~> 0.7"])
  else
    s.add_dependency(%q<redis-client>.freeze, ["~> 0.7"])
  end
end
